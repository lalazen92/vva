...
public class UploadRecordFile {
    ...
    public String doFileUpload(String urlstr, String username, String filename, String filepath){
        ...
        try
        {
            ...
            dos.writeBytes("Content-Disposition: form-data; name=\"fileinfo\";filename=\"\"" + username+"#"+filename+"\"\"" + lineEnd);
