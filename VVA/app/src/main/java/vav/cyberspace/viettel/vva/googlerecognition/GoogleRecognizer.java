package vav.cyberspace.viettel.vva.googlerecognition;
...
public class GoogleRecognizer {
     ...
     * @param apikey
     */
    public GoogleRecognizer(String language, String apikey) {
     ...
     * @param apikey
     */
     public GoogleRecognizer(Languages language, String apikey){
     ...
     * @param apikey
     */
    public GoogleRecognizer(boolean profanityFilter, String apikey){
     ...
     * @param apikey
     */
    public GoogleRecognizer(String language, boolean profanityFilter, String apikey){
    	this.language = language;
    	this.profanityFilter = profanityFilter;
        this.apikey = apikey;
    }
   ...
   /**
     ...
     * @param apikey
     */
     public GoogleRecognizer(Languages language, boolean profanityFilter, String apikey){
     	this.language = language.languageCode;
     	this.profanityFilter = profanityFilter;
        this.apikey = apikey;
     }
     ...
     *
     * @param  wavFilename file to recognize
     ...
     */
    public GoogleResponse getRecognizedDataForWave(String wavFilename, int maxResults) throws IOException{
        Wav2Flac wav2Flac = new Wav2Flac();
        String flacFile = wavFilename + ".flac";

        wav2Flac.convertWavToFlac(wavFilename, flacFile);
        
        GoogleResponse googleResponse = getRecognizedDataForFlac(flacFile, maxResults, 8000);
        
        //Delete converted FLAC data
        File deleteFile = new File(flacFile);
        deleteFile.delete();
    ...
    private String[] rawRequest(File inputFile, int maxResults, int sampleRate) throws IOException{
        ...
        // System.out.println("GoogleRecognizer.rawRequest(): url=" + url);
        ...
        // System.out.println("GoogleRecognizer.rawRequest() -> completeResponse = " + completeResponse);
